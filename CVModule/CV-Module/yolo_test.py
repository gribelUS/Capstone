...
class YOLOTrafficMonitor:
    def __init__(
        ...
        self.zone_fractions = {
            "zone_1": {"x_min": 0.35, "x_max": 0.55, "y_min": 0.10, "y_max": 0.35},
            "zone_2": {"x_min": 0.55, "x_max": 0.75, "y_min": 0.10, "y_max": 0.35},
            "zone_3": {"x_min": 0.75, "x_max": 0.90, "y_min": 0.10, "y_max": 0.35},
            "zone_4": {"x_min": 0.35, "x_max": 0.55, "y_min": 0.65, "y_max": 0.90},
            "zone_5": {"x_min": 0.55, "x_max": 0.75, "y_min": 0.65, "y_max": 0.90},
            "zone_6": {"x_min": 0.75, "x_max": 0.90, "y_min": 0.65, "y_max": 0.90},
            "zone_7": {"x_min": 0.10, "x_max": 0.30, "y_min": 0.35, "y_max": 0.65},
            "zone_8": {"x_min": 0.30, "x_max": 0.50, "y_min": 0.35, "y_max": 0.65},
            "zone_9": {"x_min": 0.50, "x_max": 0.65, "y_min": 0.35, "y_max": 0.65},
            "zone_10": {"x_min": 0.50, "x_max": 0.70, "y_min": 0.35, "y_max": 0.65},
            "zone_11": {"x_min": 0.70, "x_max": 0.90, "y_min": 0.35, "y_max": 0.65},
            "zone_12": {"x_min": 0.10, "x_max": 0.30, "y_min": 0.35, "y_max": 0.65},
        }

        self.zone_definitions = {
            key: {"x_min": 0, "x_max": 0, "y_min": 0, "y_max": 0}
            for key in self.zone_fractions
        }
    ...
    def process_video(self, frame_skip=5):
        ...
        while cap.isOpened():
            ...
            for zone_key, z in self.zone_definitions.items():
                cv2.rectangle(
                    annotated,
                ...
                cv2.putText(
                    annotated,
                    f"{zone_key}:{counts.get(zone_key, 0)}",
                    (int(z["x_min"]), int(z["y_min"]) - 5),
    ...
    def _update_zone_definitions(self, width, height):
        for zone_key, frac in self.zone_fractions.items():
            self.zone_definitions[zone_key] = {
                "x_min": frac["x_min"] * width,
                "x_max": frac["x_max"] * width,
                "y_min": frac["y_min"] * height,
                "y_max": frac["y_max"] * height,
            }
